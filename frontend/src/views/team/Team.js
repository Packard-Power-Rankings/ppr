            ...
            <CTable hover responsive>
                <CTableHead>
                    <CTableRow>
                        ...
                        <CTableHeaderCell>Home Game</CTableHeaderCell>
                        <CTableHeaderCell>Home Score</CTableHeaderCell>
                        <CTableHeaderCell>Home z-score</CTableHeaderCell>
                        <CTableHeaderCell>Away Score</CTableHeaderCell>
                        <CTableHeaderCell>Away z-score</CTableHeaderCell>
                ...
                <CTableBody>
                    {seasonOpp.map((game, index) => (
                        <CTableRow key={index}>
                            <CTableDataCell>{game.game_date}</CTableDataCell>
                            <CTableDataCell>{game.opponent_name}</CTableDataCell>
                            <CTableDataCell>{game.home_team ? 'Yes' : 'No'}</CTableDataCell>
                            <CTableDataCell>{game.home_score}</CTableDataCell>
                            <CTableDataCell>{game.home_z_score.toFixed(2)}</CTableDataCell>
                            <CTableDataCell>{game.away_score}</CTableDataCell>
                            <CTableDataCell>{game.away_z_score.toFixed(2)}</CTableDataCell>
                            <CTableDataCell>
